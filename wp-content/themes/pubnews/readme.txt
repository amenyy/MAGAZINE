...
Pubnews includes support for WooCommerce and for Infinite Scroll in Jetpack.
...
== Screenshots  ==
    ...
    * Sources:
        ...
        https://pxhere.com/en/photo/712501
        https://pxhere.com/en/photo/1061649
...
= 1.0.8 - 2nd Dec, 2024 =
    * Fixed - admin notice security issue fixed

= 1.0.7 - 17th Oct, 2024 =
    * Added - new font added

= 1.0.6 - 9th Sept, 2024 =
    * Fixed - wrong author display on single fixed

= 1.0.5 - 30th Aug, 2024 =
    * Fixed - author display on banner trailing posts fixed
    * Removed - unused code removed

= 1.0.4 - 26th Aug, 2024 =
    * Added - upsell added
    * Tweak - some css tweak

= 1.0.3 - 31st July, 2024 =
    * Updated - Header Button design issue

= 1.0.2 - 26th July, 2024 =
    * Updated - theme description updated

= 1.0.1 - 22nd July, 2024 =
    * Added - demo import added
    * Refined - code refined

= 1.0.0 - 22nd July, 2024 =
    * Initial release
